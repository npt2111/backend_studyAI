...
CHAT_GROQ_API_KEY = os.getenv("CHAT_GROQ_API_KEY", os.getenv("GROQ_API_KEY_2", "")).strip()
...
CHAT_GROQ_TIMEOUT_SECONDS = int(os.getenv("CHAT_GROQ_TIMEOUT_SECONDS", str(GROQ_TIMEOUT_SECONDS)))
CHAT_MAX_OUTPUT_TOKENS = int(os.getenv("CHAT_MAX_OUTPUT_TOKENS", "850"))
...
QUIZ_MAX_OUTPUT_TOKENS = int(os.getenv("QUIZ_MAX_OUTPUT_TOKENS", "10000"))
FLASHCARD_MAX_OUTPUT_TOKENS = int(os.getenv("FLASHCARD_MAX_OUTPUT_TOKENS", "9000"))
AI_GENERATION_BATCH_SIZE = int(os.getenv("AI_GENERATION_BATCH_SIZE", "10"))
...
GEMINI_RETRY_DELAY_SECONDS = float(os.getenv("GEMINI_RETRY_DELAY_SECONDS", "0.8"))
MINDMAP_SOURCE_MAX_CHARS = int(os.getenv("MINDMAP_SOURCE_MAX_CHARS", "18000"))
CHAT_SOURCE_MAX_CHARS = int(os.getenv("CHAT_SOURCE_MAX_CHARS", "30000"))
CHAT_CONTEXT_MAX_CHARS = int(os.getenv("CHAT_CONTEXT_MAX_CHARS", "26000"))
...
DOCUMENT_CHUNK_WORDS = int(os.getenv("DOCUMENT_CHUNK_WORDS", "450"))
DOCUMENT_CHUNK_OVERLAP_WORDS = int(os.getenv("DOCUMENT_CHUNK_OVERLAP_WORDS", "80"))
RAG_MATCH_LIMIT = int(os.getenv("RAG_MATCH_LIMIT", "3"))
RAG_MATCH_THRESHOLD = float(os.getenv("RAG_MATCH_THRESHOLD", "0.2"))
CHAT_RAG_MATCH_LIMIT = int(os.getenv("CHAT_RAG_MATCH_LIMIT", "8"))
CHAT_RAG_MATCH_THRESHOLD = float(os.getenv("CHAT_RAG_MATCH_THRESHOLD", "0.0"))
