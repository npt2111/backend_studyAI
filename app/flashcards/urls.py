...
from .views import (
    ...
    FlashcardSaveSharedApiView,
    FlashcardShareApiView,
    FlashcardSharedDetailApiView,
...
urlpatterns = [
    ...
    path("items/<uuid:flashcard_id>/share/", FlashcardShareApiView.as_view(), name="flashcard-share"),
    path("share/<str:share_code>/", FlashcardSharedDetailApiView.as_view(), name="flashcard-shared-detail"),
    path("share/<str:share_code>/save/", FlashcardSaveSharedApiView.as_view(), name="flashcard-shared-save"),
